...
export const Locanda:Restaurant = {
    PictureURL: './assets/tigerlily.svg',
    name: "Locanda",
    ChefName: "Yossi Shitrit",
    Status: ["All", "Most Popular","New"],
    dishes: [RedFarm,TaMaLaKo,VeganD],
    stars: "./assets/5Stars.svg"
}

export const KitchenMarket:Restaurant = {
    PictureURL: './assets/KitchenMarket.svg',
    name: "KitchenMarket",
    ChefName: "Yossi Shitrit",
    Status: ["All", "Open Now"],
    dishes: [PadKiMao,RedFarm,TaMaLaKo,VeganD],
...
export const Onza:Restaurant = {
    PictureURL: './assets/OnzaPic.png',
    name: "Onza",
    ChefName: "Yossi Shitrit",
    Status: ["All", "Open Now","Most Popular"],
    dishes: [PadKiMao,RedFarm,TaMaLaKo,VeganD],
...
export const Allrestaurants:Restaurant[] = [Claro
    ...
    TigerLilly,YaPan,Avra,Lumina,Locanda,KitchenMarket,Onza];