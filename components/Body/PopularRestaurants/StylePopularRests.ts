...
margin-left : ${(props) => props.Mobile ? "0" : "30%"};
margin-right:5%;
margin-bottom:5%;
...
margin: 0px;
`
export const DesktopOneDish = styled.div`
display: flex;
...
margin-right:2% ;
`
export const RestaurantMoreInfoDiv = styled.div`
display: inline-block;
justify-content: center;
width:100%;`

export const DesktopOneRestContainer = styled.div`
display: inline-block;
justify-content: center;
width: 95%;
`
export const DesktopOneResImg = styled.img`
width: 100%;
`

export const DesktopChefName = styled.p`
justify-content: center;
display: flex;
font-family: Helvetica Neue;
color: rgb(100, 100, 100);
